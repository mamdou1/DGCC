        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <InputText
                ...
                placeholder="XXXXXX"
                maxLength={6}
                className="w-full pl-12 pr-4 py-4 bg-slate-50 border-2 border-slate-200 rounded-xl focus:border-orange-500 focus:ring-4 focus:ring-orange-100 outline-none transition-all text-center text-2xl tracking-widest font-mono"
              />
            </div>
          ...
          <div className="flex items-center justify-between pt-4">
            <button
              ...
              className="flex items-center gap-2 text-sm text-orange-600 hover:text-orange-800 font-medium transition-colors disabled:opacity-50"
            >
              <RefreshCw
                size={16}
