...
export default function VerifyEmail() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dgcc13 via-white to-dgcc12 flex items-center justify-center p-4">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold text-dgcc3 uppercase tracking-wider flex items-center gap-2">
              <Key size={14} className="text-dgcc6" />
            ...
            <div className="relative">
              ...
              <InputText
                ...
                placeholder="XXXXXX"
                maxLength={6}
                className="w-full pl-12 pr-4 py-4 bg-slate-50 border-2 border-slate-200 rounded-xl focus:border-dgcc6 focus:ring-4 focus:ring-dgcc12 outline-none transition-all text-center text-2xl tracking-widest font-mono"
              />
            </div>
          ...
          <div className="flex items-center justify-between pt-4">
            <button
              ...
              className="flex items-center gap-2 text-sm text-dgcc5 hover:text-dgcc2 font-medium transition-colors disabled:opacity-50"
            >
              <RefreshCw
                size={16}
