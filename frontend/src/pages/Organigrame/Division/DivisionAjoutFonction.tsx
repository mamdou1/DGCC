// pages/Division/DivisionAjoutFonction.tsx
      ...
      <Dialog
        header={
          <div className="flex items-center gap-2 text-slate-800 font-bold">
            ...
            <span>
              {editing ? "Modifier" : "Ajouter"} une fonction à la division
            </span>
          </div>
        }
        visible={visible}
      ...
      >
        <div className="pt-4 space-y-5">
          <div className="bg-orange-50 p-4 rounded-xl border border-orange-100">
            ...
            <p className="text-orange-900 font-bold">{division?.libelle}</p>
          </div>
          ...
          <div>
            ...
            <InputText
              ...
              placeholder="Ex: Chef de division, Responsable..."
            />
          </div>
