      ...
      >
        <div className="pt-4 space-y-5">
          <div className="bg-orange-50 p-4 rounded-xl border border-orange-100">
            ...
            <p className="text-dgcc font-bold">{direction?.libelle}</p>
          </div>
          ...
          <div className="flex justify-end gap-3 pt-6 border-t border-slate-100">
            ...
            <Button
              ...
              className="bg-dgcc5 text-white font-bold px-6 py-3 rounded-xl shadow-lg hover:bg-dgcc4 transition-all"
            />
          </div>
        </div>
      </Dialog>
