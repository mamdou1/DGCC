...
export default function SectionPage() {
  ...
  const handleDelete = async (id: string) => {
    confirmDialog({
      message: `Voulez-vous supprimer cette section définitivement ? Cette action est irréversible.`,
      header: "Confirmation",
  ...
  const isLoading = isLoadingSections || isLoadingDivisions;
  const error = errorSections || errorDivisions;
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-500 font-medium">
              Gestion des sections de l'organisation
            </p>
          </div>
        </div>
        <Button
              ...
              >
                ...
                <td className="px-6 py-4">
                  <span className="flex items-center gap-2 text-slate-500 italic text-sm">
                    <Layers size={14} /> {section.division?.libelle || "N/A"}
                  </span>
                </td>
                <td className="px-6 py-4">
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        handleDelete(String(section.id));
                      }}
