...
import { createFonction } from "../../../api/fonction"; // Assurez-vous d'avoir ce entiteeUn
    ...
    <Dialog
      header={
        <div className="flex items-center gap-2 text-slate-800 font-bold">
          ...
          <span>Ajouter une fonction au {entiteeUn.titre}</span>
        </div>
      }
      visible={visible}
      style={{ width: "450px" }}
      ...
      <div className="pt-4 space-y-5">
        ...
        <div className="bg-indigo-50 p-4 rounded-xl border border-indigo-100">
          <p className="text-[10px] font-bold text-emerald-400 uppercase tracking-widest mb-1">
            {entiteeUn.titre} sélectionné(e)
          </p>
          <p className="text-indigo-900 font-bold">{entiteeUn.libelle}</p>
        </div>
