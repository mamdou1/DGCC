    ...
    <Layout>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <Button
          ...
          className="bg-dgcc3 hover:bg-dgcc2 text-white border-none px-6 py-3 rounded-xl shadow-lg transition-all shadow-dgcc10"
          onClick={() => {
            setEditing(null);
            setFormVisible(true);
          }}
              ...
              >
                ...
                <td className="px-6 py-4 font-semibold text-slate-700">
                  <div className="flex items-center gap-2">
                    <FileText
                      size={16}
                      className="text-slate-300 group-hover:text-dgcc7 transition-colors"
                    />
                    {n.libelle}
                  </div>
                </td>
