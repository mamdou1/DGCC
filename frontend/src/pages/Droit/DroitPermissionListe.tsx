    ...
    <div className="space-y-4 mt-4">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-dgcc6 outline-none"
          value={query}
          onChange={(e) => {
          ...
          <tbody className="divide-y divide-slate-50">
            {paginated.map((perm, index) => (
              ...
              >
                ...
                <td className="p-3">
                  <span className="px-2 py-0.5 rounded-full bg-dgcc12 text-dgcc3 text-[10px] font-bold">
