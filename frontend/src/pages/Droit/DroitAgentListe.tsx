    ...
    <div className="space-y-4 mt-4">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-orange-500 outline-none"
          value={query}
          onChange={(e) => {
              ...
              >
                ...
                <td className="p-3">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <span className="px-2 py-0.5 rounded-full bg-orange-100 text-orange-700 text-xs font-bold uppercase">
                      {ag.nom}
                    </span>
                  </div>
                </td>
