    ...
    <div className="space-y-4 mt-4">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-dgcc130 outline-none"
          value={query}
          onChange={(e) => {
        ...
        <table className="w-full text-left border-collapse bg-white">
          ...
          <tbody className="divide-y divide-slate-50">
            {paginated.map((ag, index) => (
              ...
              >
                <td className="p-3">
                  <span className="text-xs font-bold text-slate-400 group-hover:text-dgcc130">
                ...
                <td className="p-3">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <span className="px-2 py-0.5 rounded-full bg-dgcc13 text-dgcc3 text-xs font-bold uppercase">
                      {ag.nom}
                    </span>
                  </div>
                </td>
